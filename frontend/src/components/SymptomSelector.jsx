...
const SymptomSelector = ({ selectedSymptoms, onSymptomsChange, onSubmit, isLoading }) => {
  ...
  return (
    <div className="bg-slate-800 rounded-xl p-6 border border-slate-700 shadow-lg">
      <h3 className="text-lg font-semibold text-slate-100 mb-4">Select Your Symptoms</h3>
          ...
          <div className="absolute top-full left-0 right-0 mt-2 bg-slate-700 border border-slate-600 rounded-lg shadow-xl z-10 max-h-64 overflow-hidden">
            ...
            <div className="max-h-48 overflow-y-auto">
              {filteredSymptoms.length > 0 ? (
                ...
                <p className="px-4 py-2 text-slate-400 text-sm">No symptoms found</p>
              )}
            </div>
          </div>
        )}
